...
public class BanditShield {
	public static final float SHIELD_SIZE = 0.15f;
	private static final float MAX_CAPACITY = 2.0f;
	private static float regenRate = 0.0003f;
	private static float strength; // The current strength of the shield
	private Sprite sprite;
	private Actor owner;
	
	public BanditShield(Actor owner){
